...
function attack()
{
  text.innerText= player +" attacked "+beasts[fighting].name+" with a "+weapons[curw].name+".\n";
  let att=Math.random()-0.3;
  if(att<0)
  {
    text.innerText+= player +" missed\n";
  }
  text.innerText+=beasts[fighting].name+" attacked "+player+" with "+beasts[fighting].weapon+".\n";
...
function defeat()
{
  cele.innerText= player+" defeated "+ beasts[fighting].name+".";
  text.innerText= player+" defeated "+beasts[fighting].name+".";
...
function attackd()
{
  text.innerText= player+" attacked "+beasts[8].name+" with a "+weapons[curw].name+".\n";
  let att=Math.random()-0.3;
  if(att<0)
  {
    text.innerText+=player+" missed\n";
...
function defeatd()
{
  cele.innerText= player+" Defeated R.K. Pandey";
  text.innerText= player+" defeated "+beasts[8].name+".";
